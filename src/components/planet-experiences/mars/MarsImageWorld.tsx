...
export const MarsImageWorld: React.FC<MarsImageWorldProps> = ({ parallax, isSettled }) => {
  ...
  return (
    ...
    >
      ...
      {/* 3. Foreground Depth Ground Layer (Enhanced rock sharpness and near-ground shadow) */}
      <div
        style={{
          position: 'absolute',
          bottom: 0,
          ...
          height: '35%',
          background:
            'linear-gradient(0deg, rgba(14, 5, 3, 0.55) 0%, rgba(20, 8, 4, 0.22) 45%, rgba(0, 0, 0, 0) 100%)',
